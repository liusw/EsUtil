                    ...
                    <div class="easyui-layout" data-options="fit: true">
                        ...
                        <div data-options="region: 'center', border: false" style="overflow: hidden;">
                            <div  style="margin-top: 200px;">
                                <input type="text" id="keyword" style="width: 300px;margin-left: 35%;height: 25px;" placeholder="搜你想要的">
                                <a href="javascript(0)" class="easyui-linkbutton l-btn l-btn-small l-btn-plain" iconcls="icon-search" plain="true" group="" id="search"><span class="l-btn-text">搜一下</span><span class="l-btn-icon icon-search">&nbsp;</span></a>
                            </div>
                            <div>
...
$(function(){
    $('#keyword').keydown(function(e){
        if(e.keyCode==13){
            ...
            window.mainpage.mainTabs.addModule('搜索结果','system/search?keyword='+keyword,'icon-search')
        }
    });
});
$.ajax({
